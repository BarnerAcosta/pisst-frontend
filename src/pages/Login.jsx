...
export default function Login() {
  ...
  const motivoSesion = searchParams.get('sesion')
  const errorSesionInicial =
    motivoSesion === 'dispositivo'
      ? { errorTipo: 'sesion', error: 'Tu sesión fue cerrada porque iniciaste sesión desde otro dispositivo.' }
      : motivoSesion === 'expirada'
        ? { errorTipo: 'sesion', error: 'Tu sesión expiró. Por favor inicia sesión de nuevo.' }
        : { errorTipo: '', error: '' }

  const [error, setError] = useState(errorSesionInicial.error)
  const [errorTipo, setErrorTipo] = useState(errorSesionInicial.errorTipo)
